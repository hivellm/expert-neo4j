#!/usr/bin/env python3
"""Verifica se o dataset do Neo4j está pronto para treinar"""
...
def main():
    ...
    print("="*80)
    print("VERIFICACAO DO DATASET NEO4J")
    print("="*80)
            ...
            try:
                ...
                if assistant_match:
                    ...
                    if '<think>' in response or '<think>' in response:
                        with_reasoning += 1
                    elif response.startswith(('MATCH', 'CREATE', 'MERGE', 'RETURN', 'WITH')):
                        direct_cypher += 1
                else:
    ...
    if qwen3_rate >= 0.95 and 0.70 <= reasoning_rate <= 0.80:
        ...
        print("           Execute: python preprocess.py")
